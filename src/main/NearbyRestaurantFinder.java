...
public class NearbyRestaurantFinder {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<Restaurant> restaurants = getNearbyRestaurants(latitude, longitude, radius, maxResults);
    ...
    public static List<Restaurant> getNearbyRestaurants(double latitude, double longitude, int radius, int maxResults) throws IOException {
        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < Math.min(places.length(), maxResults); i++) {
                    ...
                    double placeLatitude = location.getDouble("lat"); // Restaurant latitude
                    double placeLongitude = location.getDouble("lng"); // Restaurant longitude
