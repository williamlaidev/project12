...
public class InMemoryRestaurantRepositoryTest {
    ...
    void setUp() {
        ...
        RestaurantDataAccess mockDataAccess = new RestaurantDataAccess() {
    ...
    void testAddRestaurant() {
        Restaurant restaurant = new Restaurant("1", "Test Restaurant", new Location(0, 0), "Address", null, 0, null, List.of(new Review("1", "Author1", "Great food!", false)),null);
    ...
    void testUpdateRestaurant() {
        ...
        Restaurant updatedRestaurant = new Restaurant("1", "Updated Restaurant", new Location(1, 1), "New Address", null, 0, null, List.of(new Review("1", "Author1", "Great food!", false)),null);
