...
public class ReviewMapperImplTest {
    ...
    void testMapReviewsToString() {
        ...
        Restaurant restaurant1 = new Restaurant("1", "Restaurant1", new Location(40.7128, -74.0060), "123 Main St", DishType.AMERICAN, 4.5, "http://example.com/photo1", "Great place!");
        Restaurant restaurant2 = new Restaurant("2", "Restaurant2", new Location(34.0522, -118.2437), "456 Elm St", DishType.ITALIAN, 4.0, "http://example.com/photo2", "Good food!");
    ...
    void testMapReviewsToStringWithUnknownRestaurant() {
        ...
        when(getRestaurantById.execute("2")).thenReturn(Optional.of(new Restaurant("2", "Restaurant2", new Location(34.0522, -118.2437), "456 Elm St", DishType.ITALIAN, 4.0, "http://example.com/photo2", "Good food!")));
