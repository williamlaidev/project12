...
public class FindAllRestaurantsTest {
    ...
    void testFindAllSuccess() {
        Restaurant restaurant1 = new Restaurant("1", "Restaurant 1", new Location(40.7128, -74.0060), "Address 1", DishType.AMERICAN, 4.5, null, null, null);
        Restaurant restaurant2 = new Restaurant("2", "Restaurant 2", new Location(34.0522, -118.2437), "Address 2", DishType.ITALIAN, 4.0, null, null, null);
